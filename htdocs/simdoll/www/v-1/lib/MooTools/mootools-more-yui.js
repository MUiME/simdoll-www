...
// Load this file's selection again by visiting: http://mootools.net/more/4f8aea31e989041d4745405bd75ed261 
// Or build this file again with packager using: packager build More/Drag More/Drag.Move More/Slider More/Assets
/*
---
copyrights:
...
e["total"+k]+=l;});},this);return Object.append(e,g);}});}).call(this);var Slider=new Class({Implements:[Events,Options],Binds:["clickedElement","draggedKnob","scrolledElement"],options:{onTick:function(a){this.setKnobPosition(a);
